...
/** The template assigned to the node */
export type Template_New = ContentTemplate & {
  __typename?: "Template_New";
  /** The name of the template */
  templateName?: Maybe<Scalars["String"]>;
};
...
export const ChceckoutDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "Chceckout" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "product_1" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
...
} as unknown as DocumentNode<ChceckoutQuery, ChceckoutQueryVariables>;
