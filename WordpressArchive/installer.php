...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'commercecore_96cfc20ff66d88df9813_20230311185049_archive.zip';
        const ARCHIVE_SIZE       = '37228785';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '96cfc20-11185049';
        const SECONDARY_PACKAGE_HASH = '7350d8e-11185049';
